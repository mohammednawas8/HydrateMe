package com.hydrate_me.hydrateme.hydrateme.presentation.app_screens.privacy_policy
...
fun PrivacyPolicyScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            PointItem(text = stringResource(id = R.string.gender_weight))
            PointItem(text = stringResource(id = R.string.wakeup_bed))
